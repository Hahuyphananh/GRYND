// POST /api/slots-pvp/disconnect-forfeit
//
// Internal endpoint called by the realtime server when a slots-pvp
...
//
// Mirrors /api/plinko-pvp/disconnect-forfeit exactly. The Clerk
...
import { forfeitMatch } from "../../../../lib/slots-pvp/serverStore.js";
...
export async function POST(req) {
  try {
    ...
    console.error("[slots-pvp:disconnect-forfeit]", err);
