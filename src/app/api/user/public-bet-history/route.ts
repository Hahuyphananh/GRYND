...
export async function GET(req: NextRequest) {
  try {
    ...
    const [
      ...
      db.select().from(slotGames).where(eq(slotGames.userId, clerkId)).limit(fetchLimit),
    ...
    const allBets = [
      ...
      ...slots.map((b: any) => formatBet("🎰 Slots", b)),
      ...coinflipFormatted,
      ...kenoFormatted,
      ...diceFormatted,
      ...poolFormatted,
