                  ...
                  style={
                    {
                      ...
                      // falling-disc layer are grid items too, and the grid
                      // places definite-position items before auto-placed
                      // ones — so an auto-placed coin board would flow around
                      // them and the whole board would shift the moment a
                      // column is hovered. Pin the coins and the board can
                      // never reflow.
