    ...
    <div className="bg-gradient-to-br from-[#001933] mt-12 to-[#000d1a] min-h-screen flex flex-col items-center text-white px-4 py-8">
      ...
      {!game ? (
        ...
        <div className="w-full max-w-5xl min-h-[650px] bg-green-700/90 rounded-[2.5rem] flex flex-col justify-between items-center shadow-2xl border-8 border-green-950 p-6 pb-40 relative overflow-hidden">
          <button
            onClick={resignGame}
            className="fixed top-24 right-5 z-50 px-4 py-2 bg-red-600 hover:bg-red-500 rounded-lg font-bold"
          >
            Resign
          </button>
          <button
                ...
                <div className="grid grid-cols-2 gap-3">
                  {["red", "blue", "green", "yellow"].map((color) => (
                    <button
                      ...
                      className="w-20 h-20 rounded-xl text-white font-bold capitalize"
          ...
          <div className="absolute bottom-4 w-full px-6">
            <div className="flex justify-center items-center gap-3 mb-2">
              <button
                ...
                className="px-4 py-2 bg-[#f5ff3b] text-[#031026] rounded-full font-bold disabled:opacity-40"
              >
                Draw card
              </button>
            ...
            <div
              className={`flex flex-wrap justify-center gap-2 rounded-2xl p-3 ${isPlayerTurn ? "ring-2 ring-yellow-300/70 shadow-[0_0_16px_rgba(253,224,71,0.6)]" : ""}`}
            >
