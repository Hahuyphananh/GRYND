...
<div className="mx-auto max-w-7xl px-4 py-8">
  ...
  <section className="mb-16">
    <div className="mb-8 flex justify-between items-center">
      ...
      <button onClick={handleLoadSports} className="bg-[#FFD700] text-[#003366] px-4 py-2 rounded hover:bg-[#FFD700]/80">
        Charger les Sports
      </button>
    </div>
  ...
  <section className="mb-16">
    <div className="mb-8 flex justify-between items-center">
      ...
      <button onClick={handleLoadEvents} className="bg-[#FFD700] text-[#003366] px-4 py-2 rounded hover:bg-[#FFD700]/80">
  ...
  <div className="lg:sticky lg:top-24">
    <BetSlip
      ...
      {notification && (
        <div className={`fixed bottom-4 right-4 p-4 rounded-lg text-white ${notification.type === "success" ? "bg-green-600" : "bg-red-600"}`}>
          {notification.message}
        </div>
      )}
      {/* Closing tag for min-h-screen bg-[#003366] div */}
    </div>
  );
}
