export const APP_TEXT_TRANSLATIONS = {
  ...
  fr: {
    ...
    games: {
      ...
      territories_name: "Territoires",
      territories_desc: "Conquérez les territoires sur la carte. Le joueur avec le plus de cases gagne !",
      roulette_name: "Roulette",
      join: "Rejoindre",
  ...
  es: {
    ...
    games: {
      ...
      territories_name: "Territorios",
      territories_desc: "Conquista territorios en el mapa. ¡El jugador con más casillas gana!",
