...
const REWARDS = [
  ...
  [18, [{ type: "title", name: "Quest Completist", desc: "Battlepass-exclusive title", rarity: "Common" }]],
  ...
  [26, [{ type: "color", name: "Sky Glow", desc: "Unlock the sky name glow", value: "#38bdf8", rarity: "Common" }]],
  ...
  [35, [{ type: "title", name: "Streak Sentinel", desc: "Battlepass-exclusive title", rarity: "Bronze" }]],
  [37, [{ type: "color", name: "Gold Glow", desc: "Unlock the gold name glow", value: "#facc15", rarity: "Common" }]],
  ...
  [50, [{ type: "title", name: "Glow Bearer", desc: "Battlepass-exclusive title", rarity: "Silver" }]],
  [51, [{ type: "color", name: "Royal Glow", desc: "Unlock the royal name glow", value: "#818cf8", rarity: "Common" }]],
  ...
  [60, [{ type: "color", name: "Golden Flame", desc: "Unlock the golden flame name glow", value: "#fde047", rarity: "Common" }]],
  ...
  [65, [{ type: "color", name: "Aurora Glow", desc: "Unlock the aurora name glow", value: "#67e8f9", rarity: "Common" }]],
  [66, [{ type: "quest_boost", name: "Quest Boost", desc: "Next 7 quest claims pay double", value: 7, rarity: "Silver" }]],
  [68, [{ type: "title", name: "Battlepass Titan", desc: "Battlepass-exclusive title", rarity: "Gold" }]],
  ...
  [72, [{ type: "color", name: "Inferno Glow", desc: "Unlock the inferno name glow", value: "#f97316", rarity: "Common" }]],
  [74, [{ type: "quest_boost", name: "Quest Boost", desc: "Next 7 quest claims pay double", value: 7, rarity: "Silver" }]],
  [75, [{ type: "title", name: "High Roller Legend", desc: "Battlepass-exclusive title", rarity: "Elite" }]],
  ...
  [85, [{ type: "color", name: "Solar Flare", desc: "Unlock the solar flare name glow", value: "#fdba74", rarity: "Common" }]],
  ...
  [90, [{ type: "color", name: "Starfire Glow", desc: "Unlock the starfire name glow", value: "#fde68a", rarity: "Common" }]],
  ...
  [95, [{ type: "color", name: "Celestial Glow", desc: "Unlock the celestial name glow", value: "#93c5fd", rarity: "Common" }]],
  ...
  [100, [
    { type: "title", name: "GRYND PASS LEGEND", desc: "The ultimate battlepass title", rarity: "Overlord" },
    { type: "color", name: "Golden Name Glow", desc: "Permanent golden name glow — the mark of a legend", value: "#f5ff3b", rarity: "Overlord" },
  ]],
];
...
export const BATTLEPASS_REWARDS = (() => {
  ...
  for (let level = 1; level <= 100; level++) {
    ...
    track.push({ level, rewards: entry ? entry[1] : [] });
  }
  return track;
})();
