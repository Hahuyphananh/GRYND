...
export function renderTemplate(
  ...
  const cta =
    ctaLabel && ctaUrl
      ...
      : "";
  return `<div style="font-family:Inter,Arial,sans-serif;max-width:620px;margin:auto;background:#0f172a;color:#e2e8f0;padding:24px;border-radius:14px"><h1 style="color:#fbbf24">GoonBet</h1><h2>${title}</h2><div>${body}</div>${cta}<p style="opacity:.75;margin-top:28px">— GoonBet Team</p></div>`;
}
